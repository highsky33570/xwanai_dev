...
export default function ChatHistorySidebar({ onCreate, inlineHidden }: ChatHistorySidebarProps) {
  ...
  return (
    <>
      <aside className={`lg:flex max-h-screen relative hidden w-[var(--left-width)] shrink-0 flex-none flex-col h-screen px-3 bg-content1 z-10`}>
        <div className={`relative w-full h-full flex-col hidden lg:flex`}>
      ...
      {isOpen && (
        <div className="fixed left-0 right-0 bottom-0 top-0 z-[9999] bg-black/30" onClick={() => setIsOpen(false)}>
